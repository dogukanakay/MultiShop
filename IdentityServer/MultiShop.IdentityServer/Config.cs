...
namespace MultiShop.IdentityServer
{
    public static class Config
    {
        ...
        public static IEnumerable<ApiScope> ApiScopes => new ApiScope[]
        {
            ...
            new ApiScope("PaymenFullPermission","Full authority for payment operations"),
        ...
        public static IEnumerable<Client> Clients => new Client[]
        {
            ...
            new Client
            {
                ...
                AllowedScopes={"CatalogFullPermission", "OcelotFullPermission", "ImageFullPermission", "CommentFullPermission" }
            },
            ...
            new Client
            {
                ...
                AllowedScopes={"CatalogFullPermission", "BasketFullPermission", "OcelotFullPermission",
                    "CommentFullPermission", "PaymenFullPermission","ImageFullPermission","OrderFullPermission","DiscountFullPermission",
            ...
            new Client
            {
                ...
                AllowedScopes={"CatalogFullPermission","DiscountFullPermission","OrderFullPermission",
                    "CargoFullPermission","BasketFullPermission","OcelotFullPermission",
                    "CommentFullPermission","PaymenFullPermission","ImageFullPermission",
                    IdentityServerConstants.LocalApi.ScopeName,
                    IdentityServerConstants.StandardScopes.Email,
                    IdentityServerConstants.StandardScopes.OpenId,
                    IdentityServerConstants.StandardScopes.Profile
