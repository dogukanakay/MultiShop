...
namespace MultiShop.Catalog.Services.FeatureServices
{
    public class FeatureService : IFeatureService
    {
        ...
        {
            await _featureCollection.DeleteOneAsync(f => f.FeatureId == id);
        }
        ...
        {
            var values = await _featureCollection.Find(f => f.FeatureId == id).FirstOrDefaultAsync();
        ...
        public async Task UpdateFeatureAsync(UpdateFeatureDto updateFeatureDto)
        {
            ...
            await _featureCollection.FindOneAndReplaceAsync(f => f.FeatureId == updateFeatureDto.FeatureId, values);
        }
    }
}
