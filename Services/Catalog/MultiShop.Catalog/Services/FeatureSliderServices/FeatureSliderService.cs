...
namespace MultiShop.Catalog.Services.FeatureSliderServices
{
    public class FeatureSliderService : IFeatureSliderService
    {
        ...
        {
            await _featureSliderCollection.DeleteOneAsync(f => f.FeatureSliderId == id);
        }
        ...
        {
            var values = await _featureSliderCollection.Find(f => f.FeatureSliderId == id).FirstOrDefaultAsync();
        ...
        public async Task UpdateFeatureSliderAsync(UpdateFeatureSliderDto updateFeatureSliderDto)
        {
            ...
            await _featureSliderCollection.FindOneAndReplaceAsync(f => f.FeatureSliderId == updateFeatureSliderDto.FeatureSliderId, values);
        }
    }
}
