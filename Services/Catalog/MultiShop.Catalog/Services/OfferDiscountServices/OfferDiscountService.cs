...
namespace MultiShop.Catalog.Services.OfferDiscountServices
{
    public class OfferDiscountService : IOfferDiscountService
    {
        ...
        {
            await _offerDiscountCollection.DeleteOneAsync(s => s.OfferDiscountId == id);
        }

        public async Task<List<ResultOfferDiscountDto>> GetAllOfferDiscountsAsync()
        {
            var values = await _offerDiscountCollection.Find(c => true).ToListAsync();
        ...
        {
            var values = await _offerDiscountCollection.Find(s => s.OfferDiscountId == id).FirstOrDefaultAsync();
        ...
        public async Task UpdateOfferDiscountAsync(UpdateOfferDiscountDto updateOfferDiscountDto)
        {
            ...
            await _offerDiscountCollection.FindOneAndReplaceAsync(c => c.OfferDiscountId == updateOfferDiscountDto.OfferDiscountId, values);
        }
    }
}
