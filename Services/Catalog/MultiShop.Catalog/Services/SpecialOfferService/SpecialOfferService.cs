...
namespace MultiShop.Catalog.Services.SpecialOfferService
{
    public class SpecialOfferService : ISpecialOfferService
    {
        ...
        {
            await _specialOfferCollection.DeleteOneAsync(s => s.SpecialOfferId == id);
        }
        ...
        {
            var values = await _specialOfferCollection.Find(s => s.SpecialOfferId == id).FirstOrDefaultAsync();
        ...
        public async Task UpdateSpecialOfferAsync(UpdateSpecialOfferDto updateSpecialOfferDto)
        {
            ...
            await _specialOfferCollection.FindOneAndReplaceAsync(c => c.SpecialOfferId == updateSpecialOfferDto.SpecialOfferId, values);
        }
    }
}
